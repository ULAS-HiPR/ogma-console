...
Project-level decisions, checkpoints, incidents, and unresolved risks are preserved in the append-only [project log](docs/project-log.md). The [documentation index](docs/README.md) separates this history from stable reference material and run-specific evidence.
